...
const socialLinks = [
  ...
  },
  {
    ...
    subText: "@_raflihmaimi",
    icon: Instagram,
    url: "https://www.instagram.com/_raflihmaimi/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@T-Haze",
    icon: Youtube,
    url: "https://www.youtube.com/@t-hazeofficial",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@T-Haze",
    icon: Github,
    url: "https://github.com/rafliaytllhhmaimi-alt",
    color: "#ffffff",
  ...
  },
  {
    ...
    icon: ({ className, ...props }) => (
      <svg
        ...
        viewBox="0 0 45 45"
        version="1.1"
        xmlns="http://www.w3.rg/2000/svg"
        xmlnsXlink="http://ww.w3.org/1999/xlink"
      >
        <title>Tiktok</title>
        <g
